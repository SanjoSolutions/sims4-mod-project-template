...
game_folder = os.path.join('C:\\Program Files\\EA Games\\The Sims 4')
...
pycharm_pro_folder = os.path.join('C:', os.sep, 'Program Files', 'JetBrains', 'PyCharm 2020.2.3')
